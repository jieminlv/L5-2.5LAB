...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.50.246/24 | 192.168.50.1 |
...
| Ethernet7 | host2_Ethernet1 | *trunk | *10,20,30,40,50,60 | *- | *- | 7 |
...
| Vlan3019 |  VRF_B  |  10.255.251.4/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.251.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_B | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| 40 | 192.168.101.3:10040 | 10040:10040 | - | - | learned |
| 50 | 192.168.101.3:10050 | 10050:10050 | - | - | learned |
| 60 | 192.168.101.3:10060 | 10060:10060 | - | - | learned |
...
| VRF_B | 192.168.101.3:20 | connected |
...
router bgp 65299
   ...
   !
   vlan 40
      rd 192.168.101.3:10040
      route-target both 10040:10040
      redistribute learned
   !
   vlan 50
      rd 192.168.101.3:10050
      route-target both 10050:10050
      redistribute learned
   !
   vlan 60
      rd 192.168.101.3:10060
