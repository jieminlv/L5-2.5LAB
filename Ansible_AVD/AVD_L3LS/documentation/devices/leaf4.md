...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.50.247/24 | 192.168.50.1 |
...
| Ethernet7 | host2_Ethernet2 | *trunk | *10,20,30,40,50,60 | *- | *- | 7 |
...
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet5 | routed | - | 192.168.103.23/31 | default | 1550 | False | - | - |
...
| Port-Channel7 | host2_PortChannel host2 | switched | trunk | 10,20,30,40,50,60 | - | - | - | - | 7 | - |
...
| Vlan3019 |  VRF_B  |  10.255.251.5/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.1.5.254 | 1 | VRF_A | - | - | - | - | - | - | - | - |
| 10.255.251.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_B | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| 40 | 192.168.101.4:10040 | 10040:10040 | - | - | learned |
| 50 | 192.168.101.4:10050 | 10050:10050 | - | - | learned |
| 60 | 192.168.101.4:10060 | 10060:10060 | - | - | learned |
...
| VRF_B | 192.168.101.4:20 | connected |
...
router bgp 65299
   ...
   neighbor 192.168.103.22 description spine3_Ethernet5
   ...
   !
   vlan 40
      rd 192.168.101.4:10040
      route-target both 10040:10040
      redistribute learned
   !
   vlan 50
      rd 192.168.101.4:10050
      route-target both 10050:10050
      redistribute learned
   !
   vlan 60
      rd 192.168.101.4:10060
