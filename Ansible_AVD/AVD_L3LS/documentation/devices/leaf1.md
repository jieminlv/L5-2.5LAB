...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.50.244/24 | 192.168.50.1 |
...
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet2 | routed | - | 192.168.103.5/31 | default | 1550 | False | - | - |
...
| Vlan3019 |  VRF_B  |  10.255.251.0/31  |  -  |  -  |  -  |  -  |  -  |
...
| 10.255.251.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF_B | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - |
...
| 40 | 192.168.101.1:10040 | 10040:10040 | - | - | learned |
| 50 | 192.168.101.1:10050 | 10050:10050 | - | - | learned |
| 60 | 192.168.101.1:10060 | 10060:10060 | - | - | learned |
...
| VRF_B | 192.168.101.1:20 | connected |
...
router bgp 65100
   ...
   neighbor 192.168.103.4 description spine3_Ethernet2
   ...
   !
   vlan 40
      rd 192.168.101.1:10040
      route-target both 10040:10040
      redistribute learned
   !
   vlan 50
      rd 192.168.101.1:10050
      route-target both 10050:10050
      redistribute learned
   !
   vlan 60
      rd 192.168.101.1:10060
